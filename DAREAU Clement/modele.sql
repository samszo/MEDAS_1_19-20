...
CREATE TABLE IF NOT EXISTS `bdd_vente`.`commande_produit` (
  ...
  INDEX `fk_commande_produit_produit1_idx` (`id_produit` ASC) )
-- ENGINE = BLACKHOLE;
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bdd_vente`.`commande` (
  ...
  INDEX `fk_commande_client_idx` (`id_client` ASC) ,
  INDEX `fk_commande_facture1_idx` (`id_facture` ASC) ,
  INDEX `fk_commande_commande_produit1_idx` (`commande_produit` ASC) ,
...
CREATE TABLE IF NOT EXISTS `bdd_vente`.`adresse_client` (
  ...
  INDEX `fk_adresse_has_client_client1_idx` (`id_client` ASC) ,
  INDEX `fk_adresse_has_client_adresse1_idx` (`id_adresse` ASC) ,
...
CREATE TABLE IF NOT EXISTS `bdd_vente`.`commande_livraison` (
  ...
  INDEX `fk_commande_has_livraison_livraison1_idx` (`num_livraison` ASC) ,
  INDEX `fk_commande_has_livraison_commande1_idx` (`num_commande` ASC) ,
