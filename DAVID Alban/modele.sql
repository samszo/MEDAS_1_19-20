...
CREATE TABLE IF NOT EXISTS `mydb`.`Musicien` (
  ...
  `lieu_de_naissance` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Groupe` (
  ...
  INDEX `fk_Groupe_Statistiques du groupe_idx` (`Fk_id_stats_groupe` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Type de materiel` (
  ...
  INDEX `fk_Type de materiel_Type de materiel1_idx` (`Fk_id_type_materiel` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Materiel` (
  ...
  INDEX `fk_Materiel_Type de materiel1_idx` (`Fk_id_type_materiel` ASC) VISIBLE,
  INDEX `fk_Materiel_Marque1_idx` (`Fk_id_marque` ASC) VISIBLE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Musicien_Groupe` (
  `Fk_id_musicien` INT NOT NULL,
  `Fk_id_groupe` INT NOT NULL,
  `date_debut_activite` DATE NULL,
  `date_fin_activité` DATE NULL,
  `Fk_id_fonction` INT NOT NULL,
  INDEX `fk_Musicien_has_Groupe_Groupe1_idx` (`Fk_id_groupe` ASC) VISIBLE,
  INDEX `fk_Musicien_has_Groupe_Musicien1_idx` (`Fk_id_musicien` ASC) VISIBLE,
  INDEX `fk_Musicien_Groupe_Fonction musicien1_idx` (`Fk_id_fonction` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Musicien_Materiel` (
  ...
  INDEX `fk_Musicien_has_Materiel_Materiel1_idx` (`Fk_id_materiel` ASC) VISIBLE,
  INDEX `fk_Musicien_has_Materiel_Musicien1_idx` (`Fk_id_musicien` ASC) VISIBLE,
