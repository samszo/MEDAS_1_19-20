...
CREATE TABLE IF NOT EXISTS `mydb`.`Auteurs` (
  ...
  INDEX `fk_Auteurs_Prix Nobel1_idx` (`Prix Nobel_ID` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Auteur a écrit` (
  ...
  INDEX `fk_Oeuvres_has_Auteurs_Auteurs1_idx` (`Auteurs_ID` ASC),
  INDEX `fk_Oeuvres_has_Auteurs_Oeuvres_idx` (`Oeuvres_ID` ASC),
