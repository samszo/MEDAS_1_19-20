La base de données contient les données d'une marque de magasins, dans laquelle on stockera les différents achats des clients, dans les différents magasins. Nous avons alors 5 tables :
