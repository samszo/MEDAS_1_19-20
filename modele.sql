...
CREATE TABLE IF NOT EXISTS `mydb`.`Commande_has_Fidelite` (
  ...
  INDEX `fk_Commande_has_Fidelite_Fidelite1_idx` (`Fidelite_idFidelite` ASC) VISIBLE,
  INDEX `fk_Commande_has_Fidelite_Commande1_idx` (`Commande_idCommande` ASC, `Commande_Client_idClient` ASC) VISIBLE,
