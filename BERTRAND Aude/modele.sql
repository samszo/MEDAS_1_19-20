...
CREATE TABLE IF NOT EXISTS `mydb`.`CONTRAT` (
  ...
  INDEX `fk_ARTICLE_has_AUTEUR_AUTEUR1_idx` (`AUTEUR_ID_AUTEUR` ASC) ,
  INDEX `fk_ARTICLE_has_AUTEUR_ARTICLE_idx` (`ARTICLE_ID_ARTICLE` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`VENTE` (
  ...
  INDEX `fk_ARTICLE_has_VENDEUR_VENDEUR1_idx` (`VENDEUR_ID_VENDEUR` ASC) ,
  INDEX `fk_ARTICLE_has_VENDEUR_ARTICLE1_idx` (`ARTICLE_ID_ARTICLE` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`PAIEMENT_DROITS` (
  ...
  INDEX `fk_VENTE_has_AUTEUR_VENTE1_idx` (`VENTE_ID_VENTE` ASC) ,
  INDEX `fk_PAIEMENT_DROITS_CONTRAT1_idx` (`CONTRAT_ID_CONTRAT` ASC, `CONTRAT_ARTICLE_ID_ARTICLE` ASC, `CONTRAT_AUTEUR_ID_AUTEUR` ASC) ,
