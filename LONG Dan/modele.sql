...
CREATE TABLE IF NOT EXISTS `Les vainqueurs de la Ligue des Champions`.`qui_ont_gagné` (
  ...
  INDEX `fk_Clubs_has_Ligue des Champions_Ligue des Champions1_idx` (`Ligue_des_Champions_id` ASC), 
  INDEX `fk_Clubs_has_Ligue des Champions_Clubs_idx` (`Clubs_id` ASC), 
...
CREATE TABLE IF NOT EXISTS `Les vainqueurs de la Ligue des Champions`.`Possède/Appartient` (
  ...
  INDEX `fk_Appartient_Clubs1_idx` (`Clubs_id` ASC), 
...
CREATE TABLE IF NOT EXISTS `Les vainqueurs de la Ligue des Champions`.`Joueurs_has_Ligue_des_Champions` (
  ...
  INDEX `fk_Joueurs_has_Ligue_des_Champions_Ligue_des_Champions1_idx` (`Ligue_des_Champions_id` ASC), 
  INDEX `fk_Joueurs_has_Ligue_des_Champions_Joueurs1_idx` (`Joueurs_id` ASC), 
