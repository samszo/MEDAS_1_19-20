...
CONSTRAINT FK_comporte_NoModule_module FOREIGN KEY(NoModule) REFERENCES module(NoModule) ON DELETE CASCADE ON UPDATE CASCADE,
...
CONSTRAINT FK_inscrip_NoStagiaire_stagiaire FOREIGN KEY(NoStagiaire) REFERENCES stagiaire(NoStagiaire) ON DELETE CASCADE on UPDATE CASCADE,
